# video_pipeline/data/dataset_qwen_video.py
...
@register_dataset("qwen_video")
class QwenVideoJsonlDataset(BaseDataset):
    def __init__(
        self,
        *,
    ...
    def __getitem__(self, i: int) -> Dict[str, Any]:
        ...
        llm_input = {"prompt": prompt, "multi_modal_data": mm_data}
